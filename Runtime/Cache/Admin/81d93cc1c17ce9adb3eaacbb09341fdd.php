...
<head>
    ...
    <title>服务商管理 - wederful后台管理系统</title>
    ...
    <script>
        var global = {
            localUrl: '<?php echo U("Provider/index/");?>',
            copyAreaUrl:'<?php echo U("Provider/copyProvider");?>',
...
<body id="body" class="pr">
    ...
    <div class="con-nav i-lh30 i-bcm h30 p10 mb20 c">
        <nav class="fl">
            <a href="<?php echo U('Provider/index/');?>">服务商管理</a>
        </nav>
        <div class="fr c">
            <!-- 第一个不需要 class ml20 -->
            ...
            <a href="<?php echo U('Provider/addProvider/');?>" class="i-button i-b-mw fl ml20">新增服务商</a>
        </div>
    </div>
    <!-- 搜索区域 select 集 -->
    <div class="mb20 c">
    ...
    <table class="i-table mb20 w1">
        ...
        <tbody>
            <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$re): $mod = ($i % 2 );++$i;?><tr data-name="<?php echo ($re["name"]); ?>" data-id="<?php echo ($re["id"]); ?>">
                    <td><?php echo ($re["category"]); ?></td>
                    <td><?php echo ($re["name"]); ?></td>
                    <td><?php echo (substr($re["contract_expires"],0,10)); ?></td>
                    ...
                    <td>
                       ...
                       <a class="edit-this dlb cp" href="<?php echo U('Provider/editProvider/');?>/id/<?php echo ($re["id"]); ?>">编辑</a>
                    </td>
    ...
    <!-- this -->
    <script src="/dev_wederful/Public/Admin/js/provider.js"></script>
