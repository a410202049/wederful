...
<head>
    ...
    <!-- this -->
    <link rel="stylesheet" href="/dev_wederful/Public/Admin/css/login.css" />
    <script>
        var global = {
            dologin:'<?php echo U("Login/doLogin");?>',
            min_url:'<?php echo U("Index/index");?>'
        };
    </script>
    <!--[if lt IE 10]>
...
<body id="body">
    ...
    <script src="/dev_wederful/Public/Admin/js/login.js"></script>
</body>
