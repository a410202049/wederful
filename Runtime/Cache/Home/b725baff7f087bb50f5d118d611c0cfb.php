...
<head>
    ...
    <link rel="stylesheet" href="/dev_wederful/Public/Home/css/custom.css" />
    ...
    <script>
        var global = {
            customMessageUrl:'<?php echo U("Index/customMessage");?>',
...
<!-- header-fixed footer-none func-none func-top-none func-contact-none -->
    ...
    <main id="main" class="main db fcf tac">
        <section class="main-wrap pr">
            <!-- welcome -->
            <img src="/dev_wederful/Public/Home/images/WeddingPlan.png" />
            <!-- main-form -->
            <div class="form-wrap">
    ...
    <script src="/dev_wederful/Public/Home/js/custom-controler.js"></script>
